...
{
    public partial class frmGiamDinhSoSanhKyQT : DevExpress.XtraEditors.XtraForm
    {
        public frmGiamDinhSoSanhKyQT()
        {
            InitializeComponent();
        ...
        public void khoiTaoKhoangThoiGianTruyVan()
        {
            ...
            this.tbThoiGianKetThuc2.Text = DateTime.Now.Year.ToString() + _month;
            this.tbThoiGianBatDau2.Text = ((int)DateTime.Now.Year - 1).ToString() + _month;
        ...
        public void khoiTaoCauTruyVan_lookUpEdit()
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien as 'Mã Câu Truy Vấn', TenDieuKien as 'Tên Câu Truy Vấn', DieuKien as 'Câu Truy Vấn SQL' FROM DanhMucDieuKienSoSanh";
        ...
        private void btnTruyVan_Click(object sender, EventArgs e)
        {
            if (this.lookUpEditCSKCB.EditValue.ToString() != "Tên CSKCB")
            {
                ...
                if (this.lookUpEditCauTruyVan.EditValue.ToString() != "Tên Câu Truy Vấn")
                {
                    ...
                    string _ngayBatDau2 = this.tbThoiGianBatDau2.Text;
                    string _ngayKetThuc2 = this.tbThoiGianKetThuc2.Text;
                    ...
                    _CauTruyVan = _CauTruyVan.Replace("_ngaybatdau2_", _ngayBatDau2);
                    _CauTruyVan = _CauTruyVan.Replace("_ngayketthuc2_", _ngayKetThuc2);
