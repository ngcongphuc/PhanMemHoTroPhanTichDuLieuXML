...
{
    public partial class frmGiamDinhThongKeMau7980a : DevExpress.XtraEditors.XtraForm
    {
        public frmGiamDinhThongKeMau7980a()
        {
            InitializeComponent();
        ...
        public void khoiTaoCauTruyVan_lookUpEdit()
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien as 'Mã Câu Truy Vấn', TenDieuKien as 'Tên Câu Truy Vấn', DieuKien as 'Câu Truy Vấn SQL' FROM dmQueryMau7980a";
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichMau7980a_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
        ...
        private void btnTruyVan_Click(object sender, EventArgs e)
        {
            if (this.lookUpEditCSKCB.EditValue.ToString() != "Tên CSKCB")
            {
                ...
                if (this.lookUpEditCauTruyVan.EditValue.ToString() != "Tên Câu Truy Vấn")
                {
                    ...
                    //_CauTruyVan = _CauTruyVan.Replace("bhyt7980a", "dmQueryMau7980a");
