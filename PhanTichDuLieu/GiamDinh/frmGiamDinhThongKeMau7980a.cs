...
namespace PhanTichDuLieu
{
    public partial class frmGiamDinhThongKeMau7980a : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichMau7980a_" + ten_cautruyvan + "_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
