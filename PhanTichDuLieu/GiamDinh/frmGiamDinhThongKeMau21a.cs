...
namespace PhanTichDuLieu
{
    public partial class frmGiamDinhThongKeMau21a : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichMau21a_" + ten_cautruyvan + "_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
