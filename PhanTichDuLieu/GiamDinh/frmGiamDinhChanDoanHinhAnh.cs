...
namespace PhanTichDuLieu
{
    public partial class frmGiamDinhChanDoanHinhAnh : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void xuatExcel_ToanBoCauLenh()
        {
            ...
            f.FileName = tenCSKCB + "_ChanDoanHinhAnh_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
