...
namespace PhanTichDuLieu
{
    public partial class frmGiamDinhThongKePhauThuatThuThuat : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichPhauThuatThuThuat_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
