...
{
    public partial class frmGiamDinhThongKePhauThuatThuThuat : DevExpress.XtraEditors.XtraForm
    {
        public frmGiamDinhThongKePhauThuatThuThuat()
        {
            InitializeComponent();
        ...
        public void khoiTaoCauTruyVan_lookUpEdit()
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien as 'Mã Câu Truy Vấn', TenDieuKien as 'Tên Câu Truy Vấn', DieuKien as 'Câu Truy Vấn SQL' FROM dmQueryPhauThuatThuThuat";
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichPhauThuatThuThuat_" + ten_cautruyvan + "_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
