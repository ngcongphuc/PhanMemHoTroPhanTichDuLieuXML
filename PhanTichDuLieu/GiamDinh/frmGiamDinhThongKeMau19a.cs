...
namespace PhanTichDuLieu
{
    public partial class frmGiamDinhThongKeMau19a : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void xuatExcel()
        {
            ...
            f.FileName = "PhanTichMau19a_" + ten_cautruyvan + "_" + DateTime.Now.Second.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString();
