...
{
    public partial class frmChiaDuLieuSQLite_7980a : Form
    {
        public frmChiaDuLieuSQLite_7980a()
        {
            //TRUNCATE TABLE
            InitializeComponent();
            ...
            this.lbLuuY.Text = "Chú ý: Dữ liệu chuẩn SQLite đưa vào bắt buộc phải chứa bảng có tên 'bhyt7980a'";
        }
        ...
        void hienThiDuLieu()
        {
            ...
            this.dtMain = SQLiteHelper.loadDatafromDB("SELECT * FROM bhyt7980a");

        }
        void tachDuLieu()
        {
            string query = "DELETE FROM bhyt7980a WHERE KY_QT NOT BETWEEN '" + this.tbThoiGianBatDau.Text + "' AND '" + this.tbThoiGianKetThuc.Text + "'";
