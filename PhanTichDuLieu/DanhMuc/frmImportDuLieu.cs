    ...
    public partial class frmImportDuLieu : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void themVaoCSDLxmlMau7980a_dtdi_BULKCOPY()
        {
            for (int i = 0; i < _FileNames.Count; i++)
            {
                ...
                string chuoiColumn = "MA_TINH_KCB, " +
                    "TEN_TINH_KCB, " +
                    "TUYENCMKT, " +
                    "TEN_CSKCB, " +
                    "ID, " +
