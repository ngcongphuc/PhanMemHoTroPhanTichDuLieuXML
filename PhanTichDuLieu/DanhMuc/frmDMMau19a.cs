...
{
    public partial class frmDMMau19a : DevExpress.XtraEditors.XtraForm
    {
        public frmDMMau19a()
        {
            InitializeComponent();
        ...
        public void khoiTaoDVKTCoDieuKien()
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien as 'Mã Điều Kiện', TenDieuKien as 'Tên Điều Kiện', DieuKien as 'Điều Kiện' FROM dmQueryMau19a";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "DELETE FROM dmQueryMau19a WHERE MaDieuKien = '" + maDieuKien + "'";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (maDieuKien != null && tenDieuKien != null && dieuKien != null)
            {
                string query = "UPDATE dmQueryMau19a SET MaDieuKien = N'" + maDieuKien + "', TenDieuKien = N'" + tenDieuKien + "', DieuKien = N'" + dieuKien + "' WHERE MaDieuKien ='" + maDieuKien + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (maDieuKien != null && tenDieuKien != null && dieuKien != null)
            {
                if (!this.kiemTraCoMaDieuKien(maDieuKien))
                {
                    ...
                    string query = "INSERT INTO dmQueryMau19a(MaDieuKien, TenDieuKien, DieuKien) VALUES(N'" + maDieuKien + "', N'" + tenDieuKien + "', N'" + dieuKien + "')";
        ...
        private bool kiemTraCoMaDieuKien(string _MaDieuKien)
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien FROM dmQueryMau19a WHERE MaDieuKien = '" + _MaDieuKien + "'";
                DataTable dt = DBUtils.GetDBTable(query, conn);
                if (dt.Rows.Count > 0)
                    return true;
                else
