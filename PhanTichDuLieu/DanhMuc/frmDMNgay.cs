...
{
    public partial class frmDMNgay : DevExpress.XtraEditors.XtraForm
    {
        public frmDMNgay()
        {
            InitializeComponent();
        ...
        public void khoiTaoDVKTCoDieuKien()
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien as 'Mã Điều Kiện', TenDieuKien as 'Tên Điều Kiện', DieuKien as 'Điều Kiện' FROM dmQueryNgay";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "DELETE FROM dmQueryNgay WHERE MaDieuKien = '" + maDieuKien + "'";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (maDieuKien != null && tenDieuKien != null && dieuKien != null)
            {
                string query = "UPDATE dmQueryNgay SET MaDieuKien = N'" + maDieuKien + "', TenDieuKien = N'" + tenDieuKien + "', DieuKien = N'" + dieuKien + "' WHERE MaDieuKien ='" + maDieuKien + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (maDieuKien != null && tenDieuKien != null && dieuKien != null)
            {
                if (!this.kiemTraCoMaDieuKien(maDieuKien))
                {
                    ...
                    string query = "INSERT INTO dmQueryNgay(MaDieuKien, TenDieuKien, DieuKien) VALUES(N'" + maDieuKien + "', N'" + tenDieuKien + "', N'" + dieuKien + "')";
        ...
        private bool kiemTraCoMaDieuKien(string _MaDieuKien)
        {
            ...
            try
            {
                string query = "SELECT MaDieuKien FROM dmQueryNgay WHERE MaDieuKien = '" + _MaDieuKien + "'";
                DataTable dt = DBUtils.GetDBTable(query, conn);
                if (dt.Rows.Count > 0)
                    return true;
                else
